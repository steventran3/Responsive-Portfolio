...
In this assignment, you'll create two different portfolios. You'll take a basic portfolio and enhance it with a mobile-responsive layout. For your second portfolio, you’ll build a layout using the Bootstrap CSS framework.
...
### Instructions
1. If you did the 'easier' assignment for Homework #1 last week, then use the material in the *Basic Portfolio* folder here:  [http://bit.ly/2gpFEPU](http://bit.ly/2gpFEPU)

2. If you did the 'recommended' assigment for Homework #1, you may the portfolio files that you handed in for your *Basic Portfolio* if you wish.
...
5. Both 'Part One' and 'Part Two' below are due for this assignment.

### Part One Instructions - (No Bootstrap)
...
### Part Two Instructions (Bootstrap)
...
Attempt to complete homework assignment (parts one and two) as described in instructions. If unable to complete certain portions, please pseudocode these portions to describe what remains to be completed.
